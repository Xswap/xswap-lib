...
describe('PairNamer', () => {
  ...
  describe('#pairName', () => {
    ...
    it('concatenation', async () => {
      expect(await pairName('DAI Stable Coin', 'MKR Token', 'Xswap V2 Liquidity Provider Share for ', '.')).to.eq(
        'Xswap V2 Liquidity Provider Share for DAI Stable Coin:MKR Token.'
      )
    })
  })
